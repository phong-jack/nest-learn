...
import { CIRCUIT_BREAKER_STATE } from 'src/utils/enums/circuit-breaker.enum';
...
export class CircuitBreaker {
  ...
  private readonly openToHalfOpenWaitTime: number = 60000; //60s
